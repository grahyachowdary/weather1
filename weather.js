...
function displayWeather(data) {
    ...
    humidityDiv.style.display = 'none'; // Hide by default
    windDiv.style.display = 'none'; // Hide by default
    ...
    if (data.cod === '404') {
        ...
        humidityDiv.style.display = 'flex'; // Show humidity
        windDiv.style.display = 'flex'; // Show wind speed
...
function setWeatherBackground(description) {
    ...
    if (description.includes('clear')) {
        backgroundImage = 'url("https://wallpaperaccess.com/full/3265131.jpg")'; // Sunny background
    } else if (description.includes('clouds')) {
        backgroundImage = 'url("https://wallpaperaccess.com/full/1462185.jpg")'; // Cloudy background
        ...
        backgroundImage = 'url("https://cdn.wallpapersafari.com/1/87/HqR9ca.jpg")'; // Thunderstorm background
    } else if (description.includes('snow')) {
        backgroundImage = 'url("https://images.wallpapersden.com/image/download/forest-house-covered-in-snow-4k_bGdnaGuUmZqaraWkpJRpZW5qrWdoZWg.jpg")'; // Snowy background
    } else if (description.includes('mist') || description.includes('fog')) {
        backgroundImage = 'url("https://magazine.vab.be/wp-content/uploads/2017/04/mist.jpg")'; // Misty/Foggy background
    }
